...
{{-- 				<div class="percent">0%</div > --}}
			...
			<h3>
				...
				<div class="btn-group pull-right">
					<button type="button" id="btn_connect_device" class="btn btn-default btn-sm">Connect</button>
				</div>
			</h3>
		</div>
		<hr>
	...
	<div class="col-md-5">
		...
		<legend>Please enter a new user</legend>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-8">
		      <input name="card" type="text" class="form-control" id="inputCard" placeholder="Please enter a valid card number">
		    </div>
		  </div>
		  <div class="form-group">
